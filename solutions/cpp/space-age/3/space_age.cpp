...
namespace space_age {
    ...
    inline double space_age::seconds() const { return age_in_seconds_; }

    double space_age::on_earth() const { return seconds() / earth_year_in_seconds; }
    double space_age::on_mercury() const { return seconds() / mercury_year_in_earth_seconds; }
    double space_age::on_venus() const { return seconds() / venus_year_in_earth_seconds; }
    double space_age::on_mars() const { return seconds() / mars_year_in_earth_seconds; }
    double space_age::on_jupiter() const { return seconds() / jupiter_year_in_earth_seconds; }
    double space_age::on_saturn() const { return seconds() / saturn_year_in_earth_seconds; }
    double space_age::on_uranus() const { return seconds() / uranus_year_in_earth_seconds; }
    double space_age::on_neptune() const { return seconds() / neptune_year_in_earth_seconds; }
}  // namespace space_age
