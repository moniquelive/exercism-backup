...
class EstateExecutor
  ...
  def self.assemble_code
    blues = Zhang::Blue.code_fragment + Khan::Blue.code_fragment + Garcia::Blue.code_fragment
    reds = Zhang::Red.code_fragment + Khan::Red.code_fragment + Garcia::Red.code_fragment
    blues * reds
  end
end
