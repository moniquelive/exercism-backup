...
attackWithSword1 monsterDamage strength =
    monsterDamage ++ String.concat [ "Attacked with sword of strength ", String.fromInt strength, "." ]


attackWithClaw1 : MonsterDamage -> Int -> MonsterDamage
attackWithClaw1 monsterDamage strength =
    monsterDamage ++ String.concat [ "Attacked with claw of strength ", String.fromInt strength, "." ]
